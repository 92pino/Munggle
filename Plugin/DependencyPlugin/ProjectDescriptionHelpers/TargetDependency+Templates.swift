...
// MARK: TargetDependency + UI

public extension TargetDependency {
    static var designSystem: Self {
        return .project(target: ModulePath.UserInterface.name, path: .designSystem)
    }
    
    static func designSystem(implements module: ModulePath.UserInterface) -> Self {
        return .project(target: ModulePath.UserInterface.name + module.rawValue, path: .designSystem(implementation: module))
    }
    
    static func designSystem(interface module: ModulePath.UserInterface) -> Self {
        return .project(target: ModulePath.UserInterface.name + module.rawValue + "Interface", path: .designSystem(implementation: module))
    }
    
    static func designSystem(tests module: ModulePath.UserInterface) -> Self {
        return .project(target: ModulePath.UserInterface.name + module.rawValue + "Tests", path: .designSystem(implementation: module))
    }
    
    static func designSystem(testing module: ModulePath.UserInterface) -> Self {
        return .project(target: ModulePath.UserInterface.name + module.rawValue + "Testing", path: .designSystem(implementation: module))
    }
}
